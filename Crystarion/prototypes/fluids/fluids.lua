...
crystal_slurry.icon = helper.icons.crystal_slurry
...
red_slurry.icon = helper.icons.red_slurry
...
blue_slurry.icon = helper.icons.blue_slurry
...
green_slurry.icon = helper.icons.green_slurry
...
yellow_mixture.icon = helper.icons.yellow_mixture
...
purple_mixture.icon = helper.icons.purple_mixture
...
plasma.icon = helper.icons.plasma
