...
local battery = {
    ...
    icons = helper.alternate("__base__/graphics/icons/battery.png", helper.icons.crystal),
    ingredients = {
...
local crystal_panel = {
    ...
    energy_required = 10,
    enabled = true,
    icons = helper.alternate("__base__/graphics/icons/solar-panel.png", helper.icons.crystal),
    ingredients = {
...
local crystal_plant = {
    ...
    energy_required = 5,
    enabled = true,
    icons = helper.alternate("__base__/graphics/icons/chemical-plant.png", helper.icons.crystal),
    ingredients = {
...
local revitalise_coal = {
    ...
    category = "crystarion-energiser-category",
    main_product = "wood",
    icons = helper.icon_2_to_1("__base__/graphics/icons/coal.png", helper.icons.crystal, "__base__/graphics/icons/wood.png"),
    ingredients = {
        { type = "item", name = "crystarion-crystal", amount = 1 },
