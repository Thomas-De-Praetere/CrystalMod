...
local crush_crystal_ore = {
    ...
    results = {
        { type = "item", name = "crystarion-crushed-crystal", amount = 3 }
    },
    energy_required = 1,
    enabled = false,
}
