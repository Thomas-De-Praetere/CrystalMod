...
local icon_table = {
    crushed_crystal = { icon = ITEM_LOCATION .. "crushed_crystal_1.png", icon_size = 64 },
    crystal_ore = { icon = ITEM_LOCATION .. "crystal_ore_1.png", icon_size = 64 },
    crystal = { icon = ITEM_LOCATION .. "crystal_1.png", icon_size = 64, tint = helper.crystal_tint.white },
    splinter = { icon = ITEM_LOCATION .. "crystal_splinter_1.png", icon_size = 64, tint = helper.crystal_tint.white },
    crystal_green = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.green },
    crystal_blue = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.blue },
    crystal_red = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.red },
    crystal_magenta = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.magenta },
    crystal_cyan = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.cyan },
    crystal_yellow = { icon = ITEM_LOCATION .. "crystal_shard_1.png", icon_size = 64, tint = helper.crystal_tint.yellow },
