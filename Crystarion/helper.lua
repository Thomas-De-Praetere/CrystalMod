...
local icon_table = {
    ...
    splinter = { icon = ITEM_LOCATION .. "crystal_splinter_1.png", icon_size = 64, tint = helper.crystal_tint.blue, scale = 0.5 },
    splinter_stable = { icon = ITEM_LOCATION .. "crystal_splinter_1.png", icon_size = 64, tint = helper.crystal_tint.white, scale = 0.5 },
